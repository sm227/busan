...
import { Heart, MapPin, Sparkles, Home as HomeIcon, Phone, Eye, ArrowLeft, Search, User, Settings, Users, BookOpen, Map } from 'lucide-react';
...
type AppState = 'welcome' | 'questionnaire' | 'matching' | 'results' | 'propertyDetail' | 'contact' | 'main' | 'community' | 'stories' | 'guide';
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mt-0.5">
                    <Search className="w-4 h-4" className="text-blue-600" />
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm">맞춤 추천</h4>
                    <p className="text-gray-600 text-xs">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mt-0.5">
                    <Heart className="w-4 h-4" className="text-green-600" />
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm">쉬운 매칭</h4>
                    <p className="text-gray-600 text-xs">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-8 h-8 bg-amber-100 rounded-lg flex items-center justify-center mt-0.5">
                    <Phone className="w-4 h-4" className="text-amber-600" />
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 text-sm">바로 연락</h4>
                    <p className="text-gray-600 text-xs">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                {selectedProperty.price.deposit && (
                  <div className="text-sm text-gray-600">
                    보증금 {(selectedProperty.price.deposit / 10000).toFixed(0)}만원
                  </div>
                )}
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900">{selectedProperty.details.rooms}룸 · {selectedProperty.details.size}평</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">유형:</span>
                    <span className="text-gray-900">{selectedProperty.details.type}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">상태:</span>
                    <span className="text-gray-900">{selectedProperty.details.condition}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mb-8">
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-medium text-gray-900 mb-2">집주인 연락처</h3>
        ...
        <div className="min-h-screen bg-gray-50">
          <div className="max-w-md mx-auto px-4 pb-8">
            ...
            <div className="space-y-4">
              {/* 최근 게시글 */}
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <h3 className="font-medium text-gray-900 mb-3">💬 최근 게시글</h3>
                <div className="space-y-3">
                  <div className="border-b border-gray-100 pb-3">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                        <span className="text-blue-600 text-sm font-medium">김</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900 text-sm">강원도 정착 후기</h4>
                        <p className="text-gray-600 text-xs mt-1">
                          도시에서 강원도로 이주한 지 1년이 되었습니다. 처음엔 걱정이 많았는데...
                        </p>
                  ...
                  <div className="border-b border-gray-100 pb-3">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                        <span className="text-green-600 text-sm font-medium">이</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900 text-sm">제주도 집 구하기 팁</h4>
                        <p className="text-gray-600 text-xs mt-1">
                          제주도에서 집 구할 때 주의할 점들을 정리해봤어요. 특히 바람이...
                        </p>
                        <div className="flex items-center text-xs text-gray-500 mt-2">
                          <span>이수정</span>
                          <span className="mx-1">·</span>
                  ...
                  <div>
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center">
                        <span className="text-amber-600 text-sm font-medium">박</span>
                      </div>
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900 text-sm">농사 초보 질문있어요</h4>
                        <p className="text-gray-600 text-xs mt-1">
                          텃밭을 시작하려고 하는데 어떤 작물부터 키우는 게 좋을까요?
                        </p>
                        <div className="flex items-center text-xs text-gray-500 mt-2">
                          <span>박민수</span>
                          <span className="mx-1">·</span>
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs">#정착후기</span>
                  <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs">#농사팁</span>
                  <span className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-xs">#집구하기</span>
                  <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs">#이웃소식</span>
                  <span className="px-3 py-1 bg-pink-100 text-pink-700 rounded-full text-xs">#생활정보</span>
                </div>
              </div>

              {/* 지역별 모임 */}
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <h3 className="font-medium text-gray-900 mb-3">🌍 지역별 모임</h3>
                <div className="space-y-2">
                  <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                    <span className="text-sm text-gray-900">강원도 이주민 모임</span>
                  ...
                  <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                    <span className="text-sm text-gray-900">전라도 농사모임</span>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <div className="flex items-center mb-3">
                  ...
                  <div className="ml-3">
                    <h3 className="font-medium text-gray-900">정민호님의 강원도 이야기</h3>
                    <p className="text-xs text-gray-600">서울 → 강원도 홍천 / 2년차</p>
                  </div>
                </div>
                <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  "서울에서 15년간 직장생활을 하다가 번아웃이 와서 시골로 내려왔어요. 
                  처음엔 모든 게 낯설고 어려웠지만, 지금은 매일 아침 산새 소리에 눈을 뜨는 게 
                  이렇게 행복할 줄 몰랐네요."
                </p>
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <div className="flex items-center mb-3">
                  ...
                  <div className="ml-3">
                    <h3 className="font-medium text-gray-900">김수연님의 제주도 이야기</h3>
                    <p className="text-xs text-gray-600">부산 → 제주도 서귀포 / 1년차</p>
                  </div>
                </div>
                <p className="text-sm text-gray-700 leading-relaxed mb-3">
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <div className="flex items-center mb-3">
                  ...
                  <div className="ml-3">
                    <h3 className="font-medium text-gray-900">박철수님의 전북 이야기</h3>
                    <p className="text-xs text-gray-600">대전 → 전북 임실 / 3년차</p>
                  </div>
                </div>
                <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  "농사를 지어보고 싶어서 내려왔는데, 이웃분들이 정말 많이 도와주셨어요. 
                  첫 해 수확한 배추로 김치를 담가서 나눠드렸을 때의 기쁨을 잊을 수 없어요."
                </p>
                <div className="flex items-center text-xs text-gray-500">
                  <Heart className="w-3 h-3 mr-1" />
        ...
        <div className="min-h-screen bg-gray-50">
          <div className="max-w-md mx-auto px-4 pb-8">
            ...
            <div className="space-y-4">
              {/* 단계별 가이드 */}
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <h3 className="font-medium text-gray-900 mb-4">📋 이주 단계별 체크리스트</h3>
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-medium">1</div>
                    <div>
                      <h4 className="font-medium text-gray-900 text-sm">지역 정보 수집</h4>
                      <p className="text-gray-600 text-xs mt-1">기후, 교통, 의료시설, 교육환경 등을 확인하세요.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-xs font-medium">2</div>
                    <div>
                      <h4 className="font-medium text-gray-900 text-sm">현지 방문</h4>
                      <p className="text-gray-600 text-xs mt-1">최소 2-3번은 직접 방문해서 생활환경을 체험해보세요.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-amber-500 text-white rounded-full flex items-center justify-center text-xs font-medium">3</div>
                    <div>
                      <h4 className="font-medium text-gray-900 text-sm">주거지 확정</h4>
                      <p className="text-gray-600 text-xs mt-1">임시거주부터 시작해서 점진적으로 정착하세요.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs font-medium">4</div>
                    <div>
                      <h4 className="font-medium text-gray-900 text-sm">지역사회 적응</h4>
                      <p className="text-gray-600 text-xs mt-1">마을 행사 참여, 이웃과의 관계 형성이 중요해요.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* 지원 정책 */}
              <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
                <h3 className="font-medium text-gray-900 mb-3">🏛️ 정부 지원 정책</h3>
                <div className="space-y-3">
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <h4 className="font-medium text-blue-900 text-sm">귀농귀촌 종합지원센터</h4>
                    <p className="text-blue-700 text-xs mt-1">상담, 교육, 정착지원 서비스를 제공합니다.</p>
                  </div>
                  <div className="bg-green-50 p-3 rounded-lg">
                    <h4 className="font-medium text-green-900 text-sm">청년 농업인 정착지원</h4>
                    <p className="text-green-700 text-xs mt-1">40세 미만 청년에게 최대 3년간 월 100만원 지원</p>
                  </div>
                  <div className="bg-amber-50 p-3 rounded-lg">
                    <h4 className="font-medium text-amber-900 text-sm">농촌 빈집 정비 지원</h4>
                    <p className="text-amber-700 text-xs mt-1">빈집 수리비용 최대 2000만원까지 지원</p>
                  </div>
                </div>
              </div>
            </div>
